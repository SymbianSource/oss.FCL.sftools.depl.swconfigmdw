 ...
 *
 */
public class ContactHintField extends AbstractByteType {
     ...
     * @param value
     */
    public ContactHintField() {
        super((byte)0);
    }

    // ~ Business Methods ======================================================
    
    public void setField(ContactHint contactHint)  {
        this.value |= contactHint.getValue();
    }
}
